...
template <typename EncodingTraits>
class input_sanitizer<EncodingTraits, binary_to_base::padding_policy::none>
{
public:
...
template <typename EncodingTraits>
class input_sanitizer<EncodingTraits, binary_to_base::padding_policy::optional>
{
public:
  template <typename Input>
...
template <typename EncodingTraits>
class input_sanitizer<EncodingTraits, binary_to_base::padding_policy::required>
{
  using BitshiftTraits = bitshift_traits<EncodingTraits>;
