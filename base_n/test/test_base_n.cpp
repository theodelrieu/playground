...
constexpr char const octal_encoding_traits::encoding_name[];

template <typename Iterator, typename Sentinel = Iterator>
using octal_encoder =
    adapters::transformer_adapter<base_n::basic_encoder<octal_encoding_traits>,
                                  Iterator,
                                  Sentinel>;

template <typename Iterator, typename Sentinel = Iterator>
using octal_decoder =
    adapters::transformer_adapter<base_n::basic_decoder<octal_encoding_traits>,
                                  Iterator,
                                  Sentinel>;
}
