...
{
  using type = detected_t<substraction, T, U>;
};

template <typename T, typename U>
struct substraction_impl<T, U, void*, void*>
{
};
}

template <typename T, typename U>
using substraction = typename detail::substraction_impl<T, U>::type;
}
};
}
}
