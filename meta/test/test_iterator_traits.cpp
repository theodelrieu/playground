...
{
  static_assert(iterator_concepts::is_iterator_traits<std::iterator_traits<char*>>::value, "");
  static_assert(iterator_concepts::is_iterator_traits<std::iterator_traits<valid_iterator>>::value, "");
