...
{
  static_assert(concepts::is_range<char [1]>::value, "");
  static_assert(concepts::is_range<char const[1]>::value, "");
  static_assert(concepts::is_range<std::string>::value, "");
  static_assert(concepts::is_range<std::vector<int>>::value, "");
  static_assert(concepts::is_range<range>::value, "");
  static_assert(concepts::is_range<sentinel_range>::value, "");

  static_assert(!concepts::is_range<char *>::value, "");
  static_assert(!concepts::is_range<non_range>::value, "");
  static_assert(!concepts::is_range<invalid_range>::value, "");

  static_assert(!concepts::is_range<struct incomplete>::value, "");
  static_assert(!concepts::is_range<void>::value, "");

  test_helpers::generate_failed_requirements_tests<
      concepts::is_range<non_range>>();

  test_helpers::generate_failed_requirements_tests<
      concepts::is_range<invalid_range>,
