...
{
  static constexpr auto nb_index_bits = log2<sizeof(EncodingTraits::alphabet)>();
  static constexpr auto nb_decoded_bytes = decoded_bytes<sizeof(EncodingTraits::alphabet)>();
  static constexpr auto nb_encoded_bytes = encoded_bytes<sizeof(EncodingTraits::alphabet)>();
