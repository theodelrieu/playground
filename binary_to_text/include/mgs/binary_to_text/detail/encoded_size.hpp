...
template <typename EncodingTraits>
struct encoded_size<EncodingTraits, binary_to_text::padding_policy::required>
{
...
template <typename EncodingTraits>
struct encoded_size<EncodingTraits, binary_to_text::padding_policy::none>
{
  constexpr meta::ssize_t operator()(meta::ssize_t decoded_size) const
  {
    using BitshiftTraits = bitshift_traits<EncodingTraits>;
...
template <typename EncodingTraits>
struct encoded_size<EncodingTraits, binary_to_text::padding_policy::optional>;
}
}
