...
template <typename EncodingTraits,
          binary_to_text::padding_policy = EncodingTraits::padding_policy>
class input_sanitizer;

template <typename EncodingTraits>
class input_sanitizer<EncodingTraits, binary_to_text::padding_policy::none>
{
public:
...
template <typename EncodingTraits>
class input_sanitizer<EncodingTraits, binary_to_text::padding_policy::optional>
{
public:
  template <typename Input>
...
template <typename EncodingTraits>
class input_sanitizer<EncodingTraits, binary_to_text::padding_policy::required>
{
  using BitshiftTraits = bitshift_traits<EncodingTraits>;
